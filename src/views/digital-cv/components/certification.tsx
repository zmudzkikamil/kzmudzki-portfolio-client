...
export const Certification: React.FC<Props> = ({ cert }) => {
  return (
    <div className="flex flex-col sm:flex-row gap-6 sm:gap-10 items-center w-full min-h-48 bg-secondary-dark p-6 rounded-2xl">
      <Icon variant="primary" iconClassName={cert.icon} size="large" />
      <div className="flex flex-col items-center sm:items-start text-center sm:text-start gap-4 sm:gap-1">
